...
const DashboardPage: React.FC = () => {
  ...
  // ACTION: Added a hyper-specific error screen for the "ID mapping" issue.
          ...
          <div className="flex items-center justify-center h-[calc(100vh-120px)]">
              <div className="w-full max-w-2xl p-8 space-y-6 text-center bg-white border-2 border-yellow-300 rounded-lg shadow-2xl dark:bg-gray-800 dark:border-yellow-700">
                  <div className="flex flex-col items-center">
                      ...
                      <h2 className="mt-4 text-2xl font-bold text-gray-800 dark:text-yellow-200">Final Step: Synchronize with Server</h2>
                      <p className="mt-2 text-gray-600 dark:text-yellow-300">
                          We've located the issue! Your local code is correct, but the server is running an older version. The only step left is to send the latest update to Supabase.
                      </p>
                  </div>
                  <div className="p-4 text-left bg-gray-100 rounded-lg dark:bg-gray-700">
                      <p className="mb-2 font-semibold text-gray-800 dark:text-gray-200">Action Required:</p>
                      <p className="mb-4 text-sm text-gray-600 dark:text-gray-400">
                          Open your terminal, navigate to your project folder, and run the command below. This will update the server with your correct company list.
                      </p>
